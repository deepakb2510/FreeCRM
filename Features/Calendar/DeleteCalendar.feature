...
@tag
Feature: Verification of delete event(s) functionality
  I want to use this template for my feature file

Background: User is logged into FreeCRM and on the Calendar page 

  @tag1
  Scenario: To validate that the user is able to delete an existing event
    Given User is on the calendar page
    And User clicks on the delete button for the existing event
